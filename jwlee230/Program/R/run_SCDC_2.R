...
main <- function(input_file, reference_file, output_file)
{
    ...
    estimation_proportion <- SCDC_prop(bulk.eset=input_eset, sc.eset=reference_eset, ct.varname="clusters", ct.sub=Idents(eleven.tils.cd3.integrated), sample="samples", verbose=TRUE, iter.max=10000)
