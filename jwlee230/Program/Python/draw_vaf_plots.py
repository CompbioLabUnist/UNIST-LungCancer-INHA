...
def draw_plot(first_sample: str, second_sample: str) -> typing.List[str]:
    ...
    merged_data["mutation"] = list(map(lambda x: x[7] in ["Nonsense_Mutation", "In_Frame_Del", "Frame_Shift_Ins", "Splice_Site", "In_Frame_Ins", "Frame_Shift_Del", "Missense_Mutation"], list(merged_data.index)))
