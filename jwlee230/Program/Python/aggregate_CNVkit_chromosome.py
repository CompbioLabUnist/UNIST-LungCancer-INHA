"""
aggregate_CNVkit_chromosome.py: Aggregate CNVkit results as chromosome view
"""
import argparse
...
if __name__ == "__main__":
    ...
    for chromosome in tqdm.tqdm(chromosome_list):
        ...
        for index, row in input_data.loc[(input_data["chromosome"] == chromosome)].iterrows():
            chromosome_data.loc[row["ID"], row["start"] // step00.big:row["end"] // step00.big] = numpy.power(2, row[watching])
