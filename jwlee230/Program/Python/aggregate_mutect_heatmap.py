"""
aggregate_mutect_heatmap.py: aggregate mutect MAF files as heatmap
"""
import argparse
import itertools
...
if __name__ == "__main__":
    ...
    seaborn.heatmap(data=output_data, xticklabels=False, yticklabels=False, cbar=False, square=True, ax=ax, cmap="Reds", vmin=0, vmax=1, linewidth=0.1, linecolor="black")

    matplotlib.pyplot.xlabel("{0} samples".format(len(sample_list)))
    matplotlib.pyplot.ylabel("{0} samples".format(len(sample_list)))
