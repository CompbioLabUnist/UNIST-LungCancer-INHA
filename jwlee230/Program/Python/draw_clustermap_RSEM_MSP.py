...
if __name__ == "__main__":
    ...
    g = seaborn.clustermap(data=input_data, figsize=(input_data.shape[1] / 4, input_data.shape[1] / 2), row_cluster=True, col_cluster=False, col_colors=col_colors, xticklabels=False, yticklabels=False, square=False, cmap="coolwarm", z_score=0, center=0, robust=True, dendrogram_ratio=(0.2, 0.0), cbar_pos=(-0.2, 0.6, 0.05, 0.18))
