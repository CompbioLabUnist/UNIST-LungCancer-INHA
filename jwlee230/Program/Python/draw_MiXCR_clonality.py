...
if __name__ == "__main__":
    ...
    try:
        stat, p = scipy.stats.kruskal(*[output_data.loc[(output_data["Stage"] == stage), "Clonality"] for stage in order])
    except ValueError:
        _, p = 0.0, 1.0

    seaborn.violinplot(data=output_data, x="Stage", y="Clonality", order=order, palette=step00.stage_color_code, cut=1, linewidth=5, ax=ax)
