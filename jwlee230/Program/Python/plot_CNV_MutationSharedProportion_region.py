...
if __name__ == "__main__":
    ...
    for MSP in tqdm.tqdm(step00.sharing_columns):
        ...
        seaborn.violinplot(data=drawing_data, x=MSP, order=MSP_order, y="Region-Loss", hue="Stage", hue_order=stage_list, palette=step00.precancer_color_code, inner="box", cut=1, linewidth=5, ax=axs[0])
        ...
        seaborn.violinplot(data=drawing_data, x=MSP, order=MSP_order, y="Region-Gain", hue="Stage", hue_order=stage_list, palette=step00.precancer_color_code, inner="box", cut=1, ax=axs[1])
