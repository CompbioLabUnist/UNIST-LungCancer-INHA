"""
plot_CNV_MutationSharedProportion_region.py: violin plot Copy Number Variation with Mutation Shared Proportion for region length
"""
import argparse
...
if __name__ == "__main__":
    ...
    for MSP in tqdm.tqdm(step00.sharing_columns):
        ...
        statannotations.Annotator.Annotator(ax, [(("Lower", stage), ("Higher", stage)) for stage in stage_list], data=output_data, x=MSP, order=["Lower", "Higher"], y="Region", hue="Stage", hue_order=stage_list).configure(test="Mann-Whitney", text_format="simple", loc="inside", verbose=0).apply_and_annotate()
