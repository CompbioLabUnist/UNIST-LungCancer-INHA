...
if __name__ == "__main__":
    ...
    g = seaborn.clustermap(data=input_data, figsize=(32, 18), row_cluster=True, col_cluster=True, cbar_pos=(-0.04, 0.2, 0.02, 0.6), col_colors=color_data, xticklabels=False, yticklabels=False, square=False, z_score=0, cmap="coolwarm", center=0, robust=True)
    ...
    for stage in tqdm.tqdm(stage_list):
        ...
        g = seaborn.clustermap(data=selected_data, figsize=(32, 18), row_cluster=True, col_cluster=True, cbar_pos=(-0.04, 0.2, 0.02, 0.6), col_colors=color_data.loc[selected_samples, args.column[0]], xticklabels=False, yticklabels=False, square=False, z_score=0, cmap="coolwarm", center=0, robust=True)
