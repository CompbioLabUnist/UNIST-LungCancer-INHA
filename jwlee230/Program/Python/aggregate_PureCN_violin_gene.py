"""
aggregate_PureCN_violin_gene.py: Violin plot PureCN data for PRE-PRI comparing over genes
"""
import argparse
import itertools
...
if __name__ == "__main__":
    ...
    for gene in tqdm.tqdm(gene_list):
        ...
        seaborn.violinplot(data=drawing_data, x="Stage", y=watching, order=drawing_stage_list, inner="box", ax=ax)
