"""
compare_MuSiC_PureCN.py: Compare MuSiC deconvolution output with PureCN CNV
"""
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument("CNV", help="PureCN CNV file(s)", type=str, nargs="+")
    ...
    elif list(filter(lambda x: not x.endswith(".csv"), args.CNV)):
        raise ValueError("CNV file must end with .CSV!!")
