...
if __name__ == "__main__":
    ...
    for MSP in tqdm.tqdm(step00.sharing_columns[:2]):
        ...
        seaborn.violinplot(data=drawing_data, x=MSP, order=MSP_order, y="Ploidy", hue="Stage", hue_order=stage_list, palette=step00.precancer_color_code, inner="box", cut=0, linewidth=5, ax=ax)
