...
if __name__ == "__main__":
    ...
    g = seaborn.clustermap(data=input_data, figsize=(18, 32), row_cluster=True, col_cluster=True, cbar_pos=None, col_colors=list(map(lambda x: "tab:red" if step00.get_patient(x) in SQCs else "tab:blue", input_data.columns)), xticklabels=True, yticklabels=True, square=False, cmap="coolwarm", z_score=0, center=0, robust=True)
