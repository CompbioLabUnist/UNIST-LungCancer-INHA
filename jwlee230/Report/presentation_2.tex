...
\begin{document}
    ...
    \section{Results}
        ...
        \subsection{Copy number variation (CNV) analysis}
            ...
            \begin{frame}[allowframebreaks]
                \frametitle{Peak-level CNV analysis in LUSC}
                ...
                \begin{figure}
                    ...
                    \end{array}$
                    \caption{Peak-level CNV plots in LUSC}
                \end{figure}
                ...
                \begin{figure}
                    ...
                    \end{array}$
                    \caption{UpSet plot among peaks in LUSC}
                \end{figure}

                \begin{table}
                    \caption{Amplification peaks in LUSC}
                ...
                \begin{table}
                    \caption{Deletion peaks in LUSC}
                    \resizebox{!}{\ifdimcomp{\height}{<}{0.35 \textheight}{\height}{0.35 \textheight}}
                ...
                \begin{figure}
                    $\begin{array}{cc}
                        ...
                        \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
                    \end{array}$
                    \caption{UpSet plot among genes in LUSC}
                \end{figure}

                \begin{table}
                    \caption{Amplification genes in LUSC}
                    \resizebox{!}{\ifdimcomp{\height}{<}{0.35 \textheight}{\height}{0.35 \textheight}}
                    {\input{tables/Gistic/BWA-CNVkit/BWA-CNVkit.SQC.Amplification.genes.tex}}
                \end{table}

                \begin{table}
                    \caption{Deletion genes in LUSC}
                    \resizebox{!}{\ifdimcomp{\height}{<}{0.35 \textheight}{\height}{0.35 \textheight}}
        ...
        \subsection{Mutational signature analysis}
            ...
            \subsubsection{MSP \& signature}
                \begin{frame}[allowframebreaks]
                    ...
                    \begin{figure}
                        $\begin{array}{ccc}
                            \includegraphics[width=0.3 \linewidth]{figures/Mutation_Shared_Proportion/Signature/SigProfiler/BWA-SQC-SBS.relative/Joint-CIS+AIS-Mutation Shared Proportion-SBS1.pdf}
                            &
                            \includegraphics[width=0.3 \linewidth]{figures/Mutation_Shared_Proportion/Signature/SigProfiler/BWA-SQC-SBS.relative/Joint-Primary-Mutation Shared Proportion-SBS1.pdf}
                            &
                            \includegraphics[width=0.3 \linewidth]{figures/Mutation_Shared_Proportion/Signature/SigProfiler/BWA-SQC-SBS.relative/Joint-All-Mutation Shared Proportion-SBS1.pdf}
                            \\
        ...
        \subsection{Differentially expressed gene (DEG) analysis}
            ...
            \subsubsection{MSP \& senescence DEG}
                \begin{frame}
                    \frametitle{MSP \& senescence DEG heatmap plot in LUSC}
                    ...
                    \begin{figure}
                        $\begin{array}{ccc}
                            ...
                            \mbox{(a) Normal} & \mbox{(b) CIS} & \mbox{(c) Primary} \\
                        \end{array}$
                        \caption{MSP \& senescence DEG heatmap in LUSC}
                    \end{figure}
                \end{frame}
