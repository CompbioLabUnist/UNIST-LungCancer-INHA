            ...
            \subsubsection{MSP \& DEG}
                ...
                \begin{frame}[allowframebreaks]
                    ...
                    \begin{columns}
                        \begin{column}{0.4 \textwidth}
                            \begin{figure}
                                \includegraphics[width=\linewidth]{figures/DEG/Violin/STAR.TPM.SQC.MSP-Median.violin/Mutation Shared Proportion_ACKR3.pdf}
                    ...
                    \begin{block}{Senescence \& cancer}
                        \begin{itemize}
                            ...
                            \item $\therefore$ Senescence $\Leftrightarrow$ Cancer progression ? \\
                                $\because$ senescence gene marker \cite{senescent-04}
                        \end{itemize}
                    \end{block}
                \end{frame}
