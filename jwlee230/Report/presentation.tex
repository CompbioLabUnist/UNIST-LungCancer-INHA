...
\begin{document}
    ...
    \subsection{Gene Expression Levels from RSEM \& DESeq2}
    \begin{frame}
        \frametitle{RSEM?}
    ...
    \begin{frame}
        ...
        \begin{figure}
            \includegraphics[width=0.4\linewidth]{figures/Workflow/DESeq2.png}
    ...
    \begin{frame}
        \frametitle{DEG Volcano Plots with Bowtie2 in SQC}
    ...
    \begin{frame}
        \frametitle{Finding in DEG Analysis}
    \end{frame}
