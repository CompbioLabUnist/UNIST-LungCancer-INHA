...
\begin{document}
    ...
    \begin{frame}
        \frametitle{DEG Venn Diagram in LUSC with Selecting Non-Recurrence}
        Normal $\rightarrow$ CIS $\rightarrow$ Primary (LUSC)
    ...
    \begin{frame}
        \frametitle{Enrichment test in LUSC with Selecting Non-Recurrence}
    \end{frame}

    \begin{frame}
        \frametitle{DEG Volcano Plots in LUAD with Selecting Non-Recurrence}
    ...
    \begin{frame}
        \frametitle{DEG Venn Diagram in LUAD with Selecting Non-Recurrence}
        Normal $\rightarrow$ AIS $\rightarrow$ Primary (LUAD)
    ...
    \begin{frame}
        \frametitle{Enrichment test in LUAD with Selecting Non-Recurrence}
    \end{frame}
