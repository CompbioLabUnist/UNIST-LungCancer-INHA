...
\begin{document}
    ...
    \begin{frame}
        \frametitle{Venn Diagram in Recurrence \& LUSC -- CIS}
    ...
    \begin{frame}
        ...
        \begin{table}
            \caption{Peaks in Recurrence \& LUSC -- CIS}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
    ...
    \begin{frame}
        \frametitle{Venn Diagram in Recurrence \& LUSC -- Precancer}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/Gistic/BWA-CNVkit/BWA-CNVkit.SQC-Precancer.NR-R.Amplification.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/Gistic/BWA-CNVkit/BWA-CNVkit.SQC-Precancer.NR-R.Deletion.pdf}
                \\
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
            \end{array}$
   ...
   \begin{frame}
       \frametitle{Venn Diagram in Recurrence \& LUSC -- Primary}

       \begin{figure}
           $\begin{array}{cc}
               \includegraphics[width=0.4 \linewidth]{figures/Gistic/BWA-CNVkit/BWA-CNVkit.SQC-Primary.NR-R.Amplification.pdf}
               &
               \includegraphics[width=0.4 \linewidth]{figures/Gistic/BWA-CNVkit/BWA-CNVkit.SQC-Primary.NR-R.Deletion.pdf}
               \\
               \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
           \end{array}$
   ...
   \begin{frame}
       ...
       \begin{table}
           \caption{Peaks in Recurrence \& LUSC -- Primary}
           $\begin{array}{cc}
               \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
   ...
   \end{frame}
    ...
    \begin{frame}
        \frametitle{Venn Diagram in Recurrence \& LUAD -- AAH}
    ...
    \begin{frame}
        \frametitle{Venn Diagram in Recurrence \& LUAD -- Precancer}
    ...
    \begin{frame}
        \frametitle{Venn Diagram in Recurrence \& LUAD -- Primary}
    ...
    \begin{frame}
        \frametitle{Venn Diagram in Smoking \& LUSC -- CIS}
    ...
    \begin{frame}
        ...
        \begin{table}
            \caption{Peaks in Smoking \& LUSC -- CIS}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
    ...
    \begin{frame}
        \frametitle{Venn Diagram in Smoking \& LUSC -- Precancer}
    ...
    \begin{frame}
        \frametitle{Venn Diagram in Smoking \& LUSC -- Primary}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{/Users/fumire/UNIST-LungCancer-INHA/jwlee230/Report/figures/Gistic/BWA-CNVkit/BWA-CNVkit.ADC-AAH.Smoking.Amplification.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{/Users/fumire/UNIST-LungCancer-INHA/jwlee230/Report/figures/Gistic/BWA-CNVkit/BWA-CNVkit.ADC-AAH.Smoking.Deletion.pdf}
                \\
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
            \end{array}$
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{/Users/fumire/UNIST-LungCancer-INHA/jwlee230/Report/figures/Gistic/BWA-CNVkit/BWA-CNVkit.ADC-Precancer.Smoking.Amplification.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{/Users/fumire/UNIST-LungCancer-INHA/jwlee230/Report/figures/Gistic/BWA-CNVkit/BWA-CNVkit.ADC-Precancer.Smoking.Deletion.pdf}
                \\
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
            \end{array}$
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{/Users/fumire/UNIST-LungCancer-INHA/jwlee230/Report/figures/Gistic/BWA-CNVkit/BWA-CNVkit.ADC-Primary.Smoking.Amplification.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{/Users/fumire/UNIST-LungCancer-INHA/jwlee230/Report/figures/Gistic/BWA-CNVkit/BWA-CNVkit.ADC-Primary.Smoking.Deletion.pdf}
                \\
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
            \end{array}$
