...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{figure}
            ...
            \end{array}$
            \caption{DEG Volcano Plots Recur vs. Non-recur with CI}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{Enrichment test Recur vs. Non-recur with CIS in LUSC}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{Enrichment test R vs. NR with Primary in LUSC}
    \end{frame}
