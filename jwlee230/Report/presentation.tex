...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cccc}
                ...
                &
                \includegraphics[width=0.2 \linewidth]{figures/Gistic/BWA/SQC-Precancer/amp_qplot.png}
                &
                ...
                &
                \includegraphics[width=0.2 \linewidth]{figures/Gistic/BWA/SQC-Precancer/del_qplot.png}
                &
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/Gistic/BWA/BWA-CNVkit.SQC-simple.Amplification.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/Gistic/BWA/BWA-CNVkit.SQC-simple.Deletion.pdf}
                \\
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
            \end{array}$
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{table}
            ...
            $\begin{array}{cc}
                ...
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC-simple.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC-simple.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cccc}
                ...
                &
                \includegraphics[width=0.2 \linewidth]{figures/Gistic/BWA/ADC-Precancer/amp_qplot.png}
                &
                ...
                &
                \includegraphics[width=0.2 \linewidth]{figures/Gistic/BWA/ADC-Precancer/del_qplot.png}
                &
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/Gistic/BWA/BWA-CNVkit.ADC-Simple.Amplification.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/Gistic/BWA/BWA-CNVkit.ADC-Simple.Deletion.pdf}
                \\
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
            \end{array}$
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{table}
            ...
            $\begin{array}{cc}
                ...
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
        ...
        \begin{table}
            ...
            $\begin{array}{cc}
                ...
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC-simple.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC-simple.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{Peaks in NR vs. R \& LUSC}
        ...
        \begin{table}
            ...
            $\begin{array}{cc}
                ...
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.NR-R.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.NR-R.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{ccc}
                ...
                \includegraphics[width=0.2 \linewidth]{figures/Gistic/BWA/SQC-CIS.Nonrecur/del_qplot.png}
                &
    ...
    \begin{frame}[allowframebreaks]
        \frametitle{Peaks in Non-recurrence \& LUSC}
        ...
        \begin{table}
            ...
            $\begin{array}{cc}
                ...
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.Nonrecur.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.Nonrecur.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
        ...
        \begin{table}
            ...
            $\begin{array}{cc}
                ...
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC-simple.Nonrecur.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC-simple.Nonrecur.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        \frametitle{Peaks in Recurrence \& LUSC}
        ...
        \begin{table}
            ...
            $\begin{array}{cc}
                ...
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.Recur.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.Recur.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
        ...
        \begin{table}
            ...
            $\begin{array}{cc}
                ...
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC-simple.Recur.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC-simple.Recur.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{Peaks in NR vs. R \& LUAD}

        \begin{table}
            \caption{Peaks in NR vs. R \& LUAD -- stage}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.25 \textheight}{\height}{0.25 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.NR-R.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.25 \textheight}{\height}{0.25 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.NR-R.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        \frametitle{Peaks in Non-recurrence \& LUAD}

        \begin{table}
            \caption{Peaks in Non-recurrence \& LUAD -- stage}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.Nonrecur.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.Nonrecur.Deletion.tex}}
                \\
            \end{array}$
        \end{table}

        \begin{table}
            \caption{Peaks in Non-recurrence \& LUAD -- PRE vs. PRI}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC-simple.Nonrecur.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC-simple.Nonrecur.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        \frametitle{Peaks in Recurrence \& LUAD}

        \begin{table}
            \caption{Peaks in Recurrence \& LUAD -- stage}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.Recur.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.Recur.Deletion.tex}}
                \\
            \end{array}$
        \end{table}

        \begin{table}
            \caption{Peaks in Recurrence \& LUAD -- PRE vs. PRI}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC-simple.Recur.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC-simple.Recur.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{Peaks in Smoking \& LUSC}

        \begin{table}
            \caption{Peaks in Smoking \& LUSC}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.Smoking.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.Smoking.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        \frametitle{Peaks in Never smoker \& LUSC}

        \begin{table}
            \caption{Peaks in Never smoker \& LUSC -- stage}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.Smoking_Never.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.Smoking_Never.Deletion.tex}}
                \\
            \end{array}$
        \end{table}

        \begin{table}
            \caption{Peaks in Never smoker \& LUSC -- PRE vs. PRI}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC-simple.Smoking_Never.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC-simple.Smoking_Never.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        \frametitle{Peaks in Ex-smoker \& LUSC}

        \begin{table}
            \caption{Peaks in Ex-smoker \& LUSC -- stage}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.Smoking_Ex.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.Smoking_Ex.Deletion.tex}}
                \\
            \end{array}$
        \end{table}

        \begin{table}
            \caption{Peaks in Ex-smoker \& LUSC -- PRE vs. PRI}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC-simple.Smoking_Ex.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC-simple.Smoking_Ex.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        \frametitle{Peaks in Current smoker \& LUSC}

        \begin{table}
            \caption{Peaks in Current smoker \& LUSC -- stage}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.Smoking_Current.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC.Smoking_Current.Deletion.tex}}
                \\
            \end{array}$
        \end{table}

        \begin{table}
            \caption{Peaks in Current smoker \& LUSC -- PRE vs. PRI}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC-simple.Smoking_Current.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.SQC-simple.Smoking_Current.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{Peaks in Smoking \& LUAD}

        \begin{table}
            \caption{Peaks in Smoking \& LUAD}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.Smoking.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.Smoking.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        \frametitle{Peaks in Ex-smoker \& LUAD}

        \begin{table}
            \caption{Peaks in Ex-smoker \& LUAD -- stage}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.25 \textheight}{\height}{0.25 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.Smoking_Ex.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.25 \textheight}{\height}{0.25 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.Smoking_Ex.Deletion.tex}}
                \\
            \end{array}$
        \end{table}

        \begin{table}
            \caption{Peaks in Ex-smoker \& LUAD -- PRE vs. PRI}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC-simple.Smoking_Ex.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC-simple.Smoking_Ex.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/Gistic/BWA/BWA-CNVkit.ADC-simple.Smoking_Current.Amplification.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/Gistic/BWA/BWA-CNVkit.ADC-simple.Smoking_Current.Deletion.pdf}
                \\

                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
            \end{array}$
            \caption{Venn Diagram in Current smoker \& LUAD -- PRE vs. PRI}
        \end{figure}
    \end{frame}

    \begin{frame}[allowframebreaks]
        \frametitle{Peaks in Current smoker \& LUAD}

        \begin{table}
            \caption{Peaks in Current smoker \& LUAD -- stage}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.Smoking_Current.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC.Smoking_Current.Deletion.tex}}
                \\
            \end{array}$
        \end{table}

        \begin{table}
            \caption{Peaks in Current smoker \& LUAD -- PRE vs. PRI}
            $\begin{array}{cc}
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\

                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC-simple.Smoking_Current.Amplification.tex}}
                &
                \resizebox{!}{\ifdimcomp{\height}{<}{0.3 \textheight}{\height}{0.3 \textheight}}
                {\input{tables/Gistic/BWA/BWA-CNVkit.ADC-simple.Smoking_Current.Deletion.tex}}
                \\
            \end{array}$
        \end{table}
    \end{frame}
