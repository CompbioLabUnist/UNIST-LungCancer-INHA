...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{table}
            ...
            \input{tables/WTS_samples/WTS_SQC_samples.tex}
        \end{table}

        \begin{table}
            \caption{Number of WTS LUAD samples}
            \input{tables/WTS_samples/WTS_ADC_samples.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{table}
            ...
            \input{tables/RSEM/Only_Stage/STAR_SQC/STAR.SQC.Normal-Dysplasia.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Normal vs. Dysplasia}
            \input{tables/RSEM/Only_Stage/STAR_SQC/STAR.SQC.Normal-Dysplasia.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{table}
            ...
            \input{tables/RSEM/Only_Stage/STAR_SQC/STAR.SQC.Normal-CIS.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Normal vs. CIS}
            \input{tables/RSEM/Only_Stage/STAR_SQC/STAR.SQC.Normal-CIS.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{table}
            ...
            \input{tables/RSEM/Only_Stage/STAR_SQC/STAR.SQC.Normal-Primary.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Normal vs. Primary}
            \input{tables/RSEM/Only_Stage/STAR_SQC/STAR.SQC.Normal-Primary.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{table}
            ...
            \input{tables/RSEM/Only_Stage/STAR_ADC/STAR.ADC.Normal-AAH.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Normal vs. AAH}
            \input{tables/RSEM/Only_Stage/STAR_ADC/STAR.ADC.Normal-AAH.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{table}
            ...
            \input{tables/RSEM/Only_Stage/STAR_ADC/STAR.ADC.Normal-AIS.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Normal vs. AIS}
            \input{tables/RSEM/Only_Stage/STAR_ADC/STAR.ADC.Normal-AIS.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{table}
            \caption{Up-regulated Pathways on Normal vs. Primary}
            \input{tables/RSEM/Only_Stage/STAR_ADC/STAR.ADC.Normal-Primary.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Normal vs. Primary}
            \input{tables/RSEM/Only_Stage/STAR_ADC/STAR.ADC.Normal-Primary.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{DEG Volcano Plots Recur vs. Non-recur with CIS in LUSC}
        ...
        \begin{figure}
            $\begin{array}{cc}
                ...
                \\
                \mbox{(a) Recurrence} & \mbox{(b) Non-recurrence} \\
            \end{array}$
            \caption{DEG Volcano Plots Recur vs. Non-recur with CIS}
        \end{figure}
    \end{frame}

    \begin{frame}
        \frametitle{DEG Venn Diagram Recur vs. Non-recur with CIS in LUSC}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Pair-Venn/STAR.SQC-CIS.Recur-Nonrecur.Up.venn.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Pair-Venn/STAR.SQC-CIS.Recur-Nonrecur.Down.venn.pdf}
                \\
                \mbox{(a) Up-regulated} & \mbox{(b) Down-regulated}
            \end{array}$
            \caption{DEG Venn Diagram Recur vs. Non-recur with CIS}
        \end{figure}
    \end{frame}

    \begin{frame}
        \frametitle{Enrichment test for Recur with CIS in LUSC}

        \begin{table}
            \caption{Up-regulated Pathways on Recur with CIS in LUSC}
            \input{tables/RSEM/SQC_Recur/STAR_Recur/STAR.SQC-CIS.Recur.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Recur with CIS in LUSC}
            \input{tables/RSEM/SQC_Recur/STAR_Recur/STAR.SQC-CIS.Recur.Down.KEGG.tex}
        \end{table}
    \end{frame}

    \begin{frame}
        \frametitle{Enrichment test for Non-recur with CIS in LUSC}

        \begin{table}
            \caption{Up-regulated Pathways on Non-recur with CIS in LUSC}
            \input{tables/RSEM/SQC_Recur/STAR_Nonrecur/STAR.SQC-CIS.Nonrecur.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Non-recur with CIS in LUSC}
            \input{tables/RSEM/SQC_Recur/STAR_Nonrecur/STAR.SQC-CIS.Nonrecur.Down.KEGG.tex}
        \end{table}
    \end{frame}

    \begin{frame}
        \frametitle{DEG Volcano Plots R vs. NR with Primary in LUSC}
        ...
        \begin{figure}
            $\begin{array}{cc}
                ...
                \mbox{(a) Recurrence} & \mbox{(b) Non-recurrence} \\
            \end{array}$
            \caption{DEG Volcano Plots Recur vs. Non-recur with Primary}
        \end{figure}
    \end{frame}

    \begin{frame}
        \frametitle{DEG Venn Diagram R vs. NR with Primary in LUSC}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Pair-Venn/STAR.SQC-Primary.Recur-Nonrecur.Up.venn.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Pair-Venn/STAR.SQC-Primary.Recur-Nonrecur.Down.venn.pdf}
                \\
                \mbox{(a) Up-regulated} & \mbox{(b) Down-regulated}
            \end{array}$
            \caption{DEG Venn Diagram Recur vs. Non-recur with Primary}
        \end{figure}
    \end{frame}

    \begin{frame}
        \frametitle{Enrichment test for Recur with Primary in LUSC}

        \begin{table}
            \caption{Up-regulated Pathways on Recur with Primary in LUSC}
            \input{tables/RSEM/SQC_Recur/STAR_Recur/STAR.SQC-Primary.Recur.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Recur with Primary in LUSC}
            \input{tables/RSEM/SQC_Recur/STAR_Recur/STAR.SQC-Primary.Recur.Down.KEGG.tex}
        \end{table}
    \end{frame}

    \begin{frame}
        \frametitle{Enrichment test for Non-recur with Primary in LUSC}

        \begin{table}
            \caption{Up-regulated Pathways on Non-recur with Primary in LUSC}
            \input{tables/RSEM/SQC_Recur/STAR_Nonrecur/STAR.SQC-Primary.Nonrecur.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Non-recur with Primary in LUSC}
            \input{tables/RSEM/SQC_Recur/STAR_Nonrecur/STAR.SQC-Primary.Nonrecur.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Pair-Venn/STAR.SQC.Recur.Up.venn.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Pair-Venn/STAR.SQC.Recur.Up.venn.pdf}
                \\
                \mbox{(a) Up-regulated} & \mbox{(b) Down-regulated} \\
    ...
    \begin{frame}
        ...
        \begin{table}
            ...
            \input{tables/RSEM/SQC_Recur_Only/STAR.SQC.Recur.Normal-CIS.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Normal vs. CIS for Recur in LUSC}
            \input{tables/RSEM/SQC_Recur_Only/STAR.SQC.Recur.Normal-CIS.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{table}
            ...
            \input{tables/RSEM/SQC_Recur_Only/STAR.SQC.Recur.Normal-Primary.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Normal vs. Primary for Recur in LUSC}
            \input{tables/RSEM/SQC_Recur_Only/STAR.SQC.Recur.Normal-Primary.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Pair-Venn/STAR.SQC.Nonrecur.Up.venn.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Pair-Venn/STAR.SQC.Nonrecur.Up.venn.pdf}
                \\
                \mbox{(a) Up-regulated} & \mbox{(b) Down-regulated} \\
    ...
    \begin{frame}
        ...
        \begin{table}
            ...
            \input{tables/RSEM/SQC_Nonrecur_Only/STAR.SQC.Nonrecur.Normal-CIS.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Normal vs. CIS for Non-recur in LUSC}
            \input{tables/RSEM/SQC_Nonrecur_Only/STAR.SQC.Nonrecur.Normal-CIS.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{table}
            ...
            \input{tables/RSEM/SQC_Nonrecur_Only/STAR.SQC.Nonrecur.Normal-Primary.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Normal vs. Primary for Non-recur in LUSC}
            \input{tables/RSEM/SQC_Nonrecur_Only/STAR.SQC.Nonrecur.Normal-Primary.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Pair-Venn/STAR.ADC.Nonrecur.Up.venn.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Pair-Venn/STAR.ADC.Nonrecur.Down.venn.pdf}
                \\
                \mbox{(a) Up-regulated} & \mbox{(b) Down-regulated} \\
            \end{array}$
    ...
    \begin{frame}
        ...
        \begin{table}
            ...
            \input{tables/RSEM/ADC_Nonrecur_Only/STAR.ADC.Nonrecur.Normal-AIS.Up.KEGG.tex}
        \end{table}

         \begin{table}
            \caption{Down-regulated Pathways on Normal vs. AIS for Non-recur in LUAD}
            \input{tables/RSEM/ADC_Nonrecur_Only/STAR.ADC.Nonrecur.Normal-AIS.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{table}
            ...
            \input{tables/RSEM/ADC_Nonrecur_Only/STAR.ADC.Nonrecur.Normal-Primary.Up.KEGG.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated Pathways on Normal vs. Primary for Non-recur in LUAD}
            \input{tables/RSEM/ADC_Nonrecur_Only/STAR.ADC.Nonrecur.Normal-Primary.Down.KEGG.tex}
        \end{table}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.SQC.violin/ActivatedDCs.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.SQC.violin/AT2.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.SQC.violin/CD1c+DCs.pdf}
                \\

                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.SQC.violin/Ciliated.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.SQC.violin/ExhaustedTfh.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.SQC.violin/mo-Mac.pdf}
                \\
            \end{array}$
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.SQC.violin/pDCs.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.SQC.violin/PleuralMac.pdf}
                \\
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.SQC.violin/Treg.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.SQC.violin/tS1.pdf}
                \\
            \end{array}$
            \caption{Violin Plots in LUSC}
        \end{figure}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.ADC.violin/Ciliated.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.ADC.violin/Club.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.ADC.violin/MAST.pdf}
                \\

                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.ADC.violin/NK.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.ADC.violin/Smoothmusclecells.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/BisqueRNA/violin/STAR.ADC.violin/Tip-likeECs.pdf}
                \\
            \end{array}$
