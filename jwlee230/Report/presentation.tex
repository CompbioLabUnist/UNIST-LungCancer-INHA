...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            \includegraphics[width=0.7 \linewidth]{figures/PureCN/BWA-violin-SQC.Recurrence.pdf}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{block}{Chr4 q-arm gain}
            \begin{enumerate}
                \item Chr5 q-arm gain in Recurrence \& Primary.
            \end{enumerate}
        ...
        \begin{block}{Chr5 q-arm gain}
            \begin{enumerate}
                \item Chr5 q-arm gain in Non-recurrence \& Precancer.
            \end{enumerate}
