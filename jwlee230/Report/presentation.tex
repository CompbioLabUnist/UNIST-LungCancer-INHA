...
\begin{document}
    ...
    \begin{frame}
        \frametitle{Enrichment test in LUSC}
    ...
    \subsubsection{Selecting Recurrence \& Comparing Stage}
    \begin{frame}
        \frametitle{DEG Volcano Plots in LUSC with Selecting Recur.}
    \end{frame}

    \begin{frame}
        \frametitle{DEG Venn Diagram in LUSC with Selecting Recur.}
    \end{frame}

    \begin{frame}
        \frametitle{Enrichment test in LUSC with Selecting Recur.}
    \end{frame}

    \subsubsection{Selecting Non-Recurrence \& Comparing Stage}
    \begin{frame}
        \frametitle{DEG Volcano Plots in LUSC with Selecting Non-Recurrence}
        Normal $\rightarrow$ CIS $\rightarrow$ Primary (LUSC)
        ...
        \begin{figure}
            ...
            \end{array}$
            \caption{DEG Volcano Plots in LUSC with Selecting Non-Recurrence}
        \end{figure}
    \end{frame}

    \begin{frame}
        \frametitle{DEG Venn Diagram in LUSC with Selecting Non-Recur.}
        Normal $\rightarrow$ CIS $\rightarrow$ Primary (LUSC)
        ...
        \begin{figure}
            $\begin{array}{cc}
                ...
                \mbox{(a) Up-regulated} & \mbox{(b) Down-regulated} \\
            \end{array}$
            \caption{DEG Venn Diagram in LUSC with Selecting Non-Recurrence}
        \end{figure}
    \end{frame}

    \begin{frame}
        \frametitle{Enrichment test in LUSC with Selecting Non-Recur.}
    \end{frame}

    \begin{frame}
        \frametitle{DEG Volcano Plots in LUAD with Selecting Non-Recur.}
        Normal $\rightarrow$ AIS $\rightarrow$ Primary (LUAD)
        ...
        \begin{figure}
            ...
            \end{array}$
            \caption{DEG Volcano Plots in LUAD with Selecting Non-Recurrence}
        \end{figure}
    \end{frame}

    \begin{frame}
        \frametitle{DEG Venn Diagram in LUAD with Selecting Non-Recur.}
        Normal $\rightarrow$ AIS $\rightarrow$ Primary (LUAD)
        ...
        \begin{figure}
            $\begin{array}{cc}
                ...
                \mbox{(a) Up-regulated} & \mbox{(b) Down-regulated} \\
            \end{array}$
            \caption{DEG Venn Diagram in LUAD with Selecting Non-Recurrence}
        \end{figure}
    \end{frame}

    \begin{frame}
        \frametitle{Enrichment test in LUAD with Selecting Non-Recur.}
    \end{frame}

    \subsubsection{Selecting Stage \& Comparing Recurrence}
    \begin{frame}
        \frametitle{DEG Volcano Plots in LUSC with Selecting Stage}
        ...
        \begin{figure}
            ...
            \end{array}$
            \caption{DEG Volcano Plots in LUSC with Selecting Stage}
        \end{figure}
    \end{frame}

    \begin{frame}
        \frametitle{Enrichment test in LUSC with Selecting CIS}
    \end{frame}

    \begin{frame}
        \frametitle{Enrichment test in LUSC with Selecting Primary}
    \end{frame}
