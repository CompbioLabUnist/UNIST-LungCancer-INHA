...
\begin{document}
    ...
    \begin{frame}
        \frametitle{Copy Number Variation on WES}

        \begin{figure}
            \includegraphics[width=\linewidth]{figures/Sequenza/BWA-genome.pdf}
            \caption{Copy Number Variation by patients and chromosomes}
        \end{figure}
    \end{frame}
