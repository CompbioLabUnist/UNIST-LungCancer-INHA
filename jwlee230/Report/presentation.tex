...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            ...
            \caption{CNV Violin Plot in LUSC}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            ...
            \caption{CNV Violin Plot in LUSC with Recurrence}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            \includegraphics[width=\linewidth]{figures/Sequenza/BWA-simple-SQC.Smoking.pdf}
            \caption{LUSC with Smoking in CNV Plot}
        \end{figure}

        \begin{figure}
            \includegraphics[width=0.8 \linewidth]{figures/Sequenza/BWA-violin-SQC.Smoking.pdf}
            \caption{CNV Violin Plot in LUSC with Smoking}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            ...
            \caption{CNV Violin Plot in LUAD}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            ...
            \caption{CNV Violin Plot in LUAD with Recurrence}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            \includegraphics[width=\linewidth]{figures/Sequenza/BWA-simple-ADC.Smoking.pdf}
            \caption{LUAD with Smoking in CNV Plot}
        \end{figure}

        \begin{figure}
            \includegraphics[width=0.8 \linewidth]{figures/Sequenza/BWA-violin-ADC.Smoking.pdf}
            \caption{CNV Violin Plot in LUAD with Smoking}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/PyClone/BWA-Plots/48A1.CCF.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/PyClone/BWA-Plots/48A2.CCF.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/PyClone/BWA-Plots/48A3.CCF.pdf}
                \\
                \mbox{(a) 48A1} & \mbox{(b) 48A2} & \mbox{(c) 48A3} \\
            \end{array}$
            \caption{Cancer Cell Fraction plot in patient \#48}
        \end{figure}

        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/PyClone/BWA-Plots/48A1.VAF.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/PyClone/BWA-Plots/48A2.VAF.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/PyClone/BWA-Plots/48A3.VAF.pdf}
                \\
                \mbox{(a) 48A1} & \mbox{(b) 48A2} & \mbox{(c) 48A3} \\
            \end{array}$
            \caption{VAF plot in patient \#48}
        \end{figure}
    \end{frame}
