...
\begin{document}
    ...
    \begin{frame}
        \frametitle{DEG List for Recur in CIS of LUSC}

        \begin{table}
            \caption{Up-regulated DEG for Recur in CIS of LUSC}
            \input{tables/DEG/STAR.SQC.CIS.Nonrecur-Recur.DEG.Up.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated DEG for Recur in CIS of LUSC}
            \input{tables/DEG/STAR.SQC.CIS.Nonrecur-Recur.DEG.Down.tex}
        \end{table}
    \end{frame}

    \begin{frame}
        \frametitle{DEG List for Recur in Primary of LUSC}

        \begin{table}
            \caption{Up-regulated DEG for Recur in Primary of LUSC}
            \input{tables/DEG/STAR.SQC.Primary.Nonrecur-Recur.DEG.Up.tex}
        \end{table}

        \begin{table}
            \caption{Down-regulated DEG for Recur in Primary of LUSC}
            \input{tables/DEG/STAR.SQC.Primary.Nonrecur-Recur.DEG.Down.tex}
        \end{table}
    \end{frame}

    \begin{frame}
        \frametitle{DEG Volcano Plots Recur vs. Non-recur in LUSC}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Volcano/STAR.SQC.CIS.Nonrecur-Recur.volcano.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Volcano/STAR.SQC.Primary.Nonrecur-Recur.volcano.pdf}
                \\
                \mbox{(a) CIS} & \mbox{(b) Primary} \\
            \end{array}$
            \caption{DEG Volcano Plots Recur vs. Non-recur}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Pair-Venn/STAR.SQC.CIS-Primary.Recur-Nonrecur.Up.venn.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/DEG/Pair-Venn/STAR.SQC.CIS-Primary.Recur-Nonrecur.Down.venn.pdf}
                \\
                \mbox{(a) Up-regulated} & \mbox{(b) Down-regulated}
            \end{array}$
            \caption{DEG Venn Diagram Recur vs. Non-recur}
        \end{figure}
    \end{frame}
