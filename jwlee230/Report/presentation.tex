...
\begin{document}
    ...
    \subsubsection{Gistic by Recurrence}
    \begin{frame}
        \frametitle{Gistic in NR vs. R}
    \end{frame}

    \begin{frame}
        \frametitle{Gistic in Non-recurrence}
    \end{frame}

    \begin{frame}
        \frametitle{Gistic in Recurrence}
    \end{frame}

    \subsubsection{Gistic by Smoking}
    \begin{frame}
        \frametitle{Gistic in Smoking history}
    \end{frame}

    \begin{frame}
        \frametitle{Gistic in Never smoker}
    \end{frame}
