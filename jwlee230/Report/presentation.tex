...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{figure}
            \includegraphics[height=0.7 \textheight]{figures/CIBERSORTx/clustermap/Bowtie2.SQC.cluster.pdf}
    ...
    \begin{frame}
        ...
        \begin{figure}
            \includegraphics[width=0.8 \linewidth]{figures/CIBERSORTx/clustermap/Bowtie2.ADC.cluster.pdf}
