...
\begin{document}
    ...
    \subsubsection{Gistic by Histology}
    \begin{frame}
        \frametitle{Gistic by Histology}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.2 \linewidth]{figures/Gistic/BWA/SQC/amp_qplot.png}
                &
                \includegraphics[width=0.2 \linewidth]{figures/Gistic/BWA/ADC/amp_qplot.png}
                \\

                \includegraphics[width=0.2 \linewidth]{figures/Gistic/BWA/SQC/del_qplot.png}
                &
                \includegraphics[width=0.2 \linewidth]{figures/Gistic/BWA/ADC/del_qplot.png}
                \\

                \mbox{(a) LUSC} & \mbox{(b) LUAD} \\
            \end{array}$
            \caption{Gistic results by Histology}
        \end{figure}
    \end{frame}

    \begin{frame}
        \frametitle{Venn Diagram by Histology}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/Gistic/BWA/BWA-CNVkit.Histology.Amplification.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/Gistic/BWA/BWA-CNVkit.Histology.Deletion.pdf}
                \\
                \mbox{(a) Amplification} & \mbox{(b) Deletion} \\
            \end{array}$
            \caption{Venn Diagram among Peaks by Histology}
        \end{figure}
    \end{frame}

    \subsubsection{Gistic by Stage}
    \begin{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{block}{Natural Killer cells (NK cells)}
            \begin{enumerate}
                ...
                \item NK cells can induce immune response against tumor cells \cite{NK-3}.
